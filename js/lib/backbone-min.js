(function (t, e) {
  ...
  i.extend(p.prototype, u, {
    ...
    set: function (t, e, r) {
      ...
      if (!h) {
        if (o.length) this._pending = true;
  ...
  i.extend(N.prototype, u, {
    ...
    start: function (t) {
      ...
      this.fragment = r;
      var a = this.location;
      var o = a.pathname.replace(/[^\/]$/, "$&/") === this.root;
      if (this._wantsHashChange && this._wantsPushState) {
        if (!this._hasPushState && !o) {
          this.fragment = this.getFragment(null, true);
          this.location.replace(
            this.root + this.location.search + "#" + this.fragment
          );
          return true;
        } else if (this._hasPushState && o && a.hash) {
  ...
  p.extend = g.extend = S.extend = w.extend = N.extend = U;
  var M = function () {
